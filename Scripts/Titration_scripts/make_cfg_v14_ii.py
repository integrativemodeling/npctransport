...
for i in rrange:
    ...
    if n_kaps>0:
        ...
        create_range(interaction.interaction_k, 0.6*kap_k, 1.4*kap_k, steps=75, base=1)
        create_range(interaction.interaction_range, 0.6*kap_range, 1.4*kap_range, steps=75, base=1)

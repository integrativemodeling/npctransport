...
for i in rrange:
    ...
    if n_kaps>0:
        ...
        create_range(interaction.interaction_k, 0.9*kap_k, 1.1*kap_k, steps=2, base=1)
        create_range(interaction.interaction_range, 0.9*kap_range, 1.1*kap_range, steps=2, base=1)
